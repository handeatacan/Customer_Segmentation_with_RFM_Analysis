...
# 2. Veri setinde
        ...
        # b. Değişken isimleri,
        # c. Boyut,
        # d. Betimsel istatistik, = describe()
        # e. Boş değer,
        # f. Değişken tipleri, incelemesi yapınız. Yapısal bilgileri
...
# 5. Alışveriş kanallarındaki / kırılımındaki müşteri sayısının, toplam alınan ürün sayısı ve toplam harcamaların dağılımına bakınız.
